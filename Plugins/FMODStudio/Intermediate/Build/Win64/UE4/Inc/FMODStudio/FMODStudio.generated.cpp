...
// Cross Module References
	...
	FMODSTUDIO_API class UFunction* Z_Construct_UFunction_UFMODAudioComponent_Release();
	...
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODAnimNotifyPlay_NoRegister();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODAnimNotifyPlay();
	...
	FMODSTUDIO_API class UEnum* Z_Construct_UEnum_FMODStudio_EFMODEventControlKey();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventControlSection_NoRegister();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventControlSection();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventControlTrack_NoRegister();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventControlTrack();
	FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODEventParameterNameAndCurve();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventParameterSection_NoRegister();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventParameterSection();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventParameterTrack_NoRegister();
	FMODSTUDIO_API class UClass* Z_Construct_UClass_UFMODEventParameterTrack();
	...
	FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate();
	FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODEventParameterSectionTemplate();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODEventProperty(EFMODEventProperty_StaticEnum, TEXT("/Script/FMODStudio"), TEXT("EFMODEventProperty"), false, nullptr, nullptr);
	...
	uint32 Get_Z_Construct_UEnum_FMODStudio_EFMODEventProperty_CRC() { return 27169218U; }
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_Release()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Release"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODAudioComponent_GetParameter(), "GetParameter"); // 4186793429
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODAudioComponent_Release(), "Release"); // 3667107814
	...
	IMPLEMENT_CLASS(UFMODAudioComponent, 1389475840);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(AFMODAmbientSound, 937460672);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODAsset, 316484874);
	...
	IMPLEMENT_CLASS(UFMODEvent, 3487157525);
	...
	UClass* Z_Construct_UClass_UFMODAnimNotifyPlay()
	{
		...
		if (!OuterClass)
		{
			...
			{
				UObjectForceRegistration(OuterClass);
				OuterClass->ClassFlags |= 0x20112080;
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bFollow, UFMODAnimNotifyPlay, uint8);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODAnimNotifyPlay, 1588420652);
	...
	IMPLEMENT_CLASS(UFMODBank, 2571125151);
	...
	UClass* Z_Construct_UClass_UFMODBus()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UFMODBus> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UFMODBus, 4191966971);
	...
	IMPLEMENT_CLASS(UFMODSnapshot, 46970087);
	...
	IMPLEMENT_CLASS(UFMODVCA, 2281462079);
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventInstance
{
	...
	void UFMODBlueprintStatics::StaticRegisterNativesUFMODBlueprintStatics()
	{
		...
		FNativeFunctionRegistrar::RegisterFunctions(Class, AnsiFuncs, 33);
	}
	...
	IMPLEMENT_CLASS(UFMODBlueprintStatics, 907525463);
...
static UEnum* EFMODEventControlKey_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIO_API class UEnum* Z_Construct_UEnum_FMODStudio_EFMODEventControlKey();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODEventControlKey(EFMODEventControlKey_StaticEnum, TEXT("/Script/FMODStudio"), TEXT("EFMODEventControlKey"), false, nullptr, nullptr);
	...
	uint32 Get_Z_Construct_UEnum_FMODStudio_EFMODEventControlKey_CRC() { return 1771189200U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODEventControlSection, 3602076455);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODEventControlTrack, 3120120569);
...
class UScriptStruct* FFMODEventParameterNameAndCurve::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODEventParameterNameAndCurve();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODEventParameterSection, 3131881943);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODEventParameterTrack, 2960015806);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODSpeakerMode(EFMODSpeakerMode_StaticEnum, TEXT("/Script/FMODStudio"), TEXT("EFMODSpeakerMode"), false, nullptr, nullptr);
	...
	uint32 Get_Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode_CRC() { return 1224021411U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODSettings, 1272523858);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UFMODSnapshotReverb, 3253825572);
...
class UScriptStruct* FFMODEventControlSectionTemplate::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate();
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventControlSectionTemplate
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FMODEventControlSectionTemplate"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), Z_Construct_UScriptStruct_FMovieSceneEvalTemplate(), new UScriptStruct::TCppStructOps<FFMODEventControlSectionTemplate>, EStructFlags(0x00000001));
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_CRC() { return 3255908031U; }
class UScriptStruct* FFMODEventParameterSectionTemplate::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODEventParameterSectionTemplate();
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventParameterSectionTemplate
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventParameterSectionTemplate_CRC() { return 756341642U; }
